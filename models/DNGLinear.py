...
class DLinearModel(nn.Module):
    ...
    """
    def __init__(self, input_size, output_horizon, in_num_features):
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.NLinear = NLinearModel(self.seq_len, self.pred_len)
        self.DLinear = DLinearModel(self.seq_len, self.pred_len, self.in_num_features)
##############################################
